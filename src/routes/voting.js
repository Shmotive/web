...
export default function VotingPage() {
  ...
  const {
    data: lobbyQueryData,
    loading: lobbyQueryLoading,
    error: lobbyQueryError,
  } = useQuery(GET_LOBBY, {
    variables: {
      lobby_code: code,
    },
  ...
  const {
    data: lobbySubscriptionData,
    loading: lobbySubscriptionLoading,
    error: lobbySubscriptionError,
  } = useSubscription(VOTING_PAGE_SUBSCRIPTION, {
    variables: {
      lobbyCode: code,
      uuid: uuid,
    },
